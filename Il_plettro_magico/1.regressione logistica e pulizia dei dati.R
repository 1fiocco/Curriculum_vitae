...
#l etnia dell'unità statistica, la sua religione o il luogo di residenza .
...
#abbiamo anche imposto che l'età sia maggiore di zero, perchè ci sono dei valori
...
p.soglia.vec    = seq(from=1,to=0,length.out = 867)
sensitivity.vec = c()
specificity.vec = c()
...
#i dati che servono nella nostra regressione logistica ad eccezione di mar, e ora che ne andiamo a
